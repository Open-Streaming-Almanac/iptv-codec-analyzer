...
[![CI](https://github.com/Open-Streaming-Almanac/iptv-codec-analyzer/actions/workflows/test.yml/badge.svg)](https://github.com/Open-Streaming-Almanac/iptv-codec-analyzer/actions)
...
See the docstring at the top of [`iptv_codec_analyzer.py`](./iptv_codec_analyzer.py) —
